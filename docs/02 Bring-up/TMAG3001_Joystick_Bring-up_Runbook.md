...
|---|---|---|---|---|---|---|
| 1 | probe | `0x34` | I2C address transaction | TBD | ACK | HW5 preliminary scan: `0x34..0x37` all NACKed; full I2C scan found only `0x18` and `0x46`, so TMAG visibility is blocked pending hardware inspection |
